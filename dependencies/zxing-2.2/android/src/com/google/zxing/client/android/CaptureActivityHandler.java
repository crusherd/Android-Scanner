...
public final class CaptureActivityHandler extends Handler {
  ...
  CaptureActivityHandler(final CaptureActivity activity,
                         final Collection<BarcodeFormat> decodeFormats,
                         final Map<DecodeHintType,?> baseHints,
  ...
  public void handleMessage(final Message message) {
    if (message.what == R.id.restart_preview) {
        ...
        if (bundle != null) {
          final byte[] compressedBitmap = bundle.getByteArray(DecodeThread.BARCODE_BITMAP);
