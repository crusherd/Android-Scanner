...
public final class HistoryActivity extends ListActivity {
  ...
  private void reloadHistoryItems() {
    final List<HistoryItem> items = historyManager.buildHistoryItems();
    adapter.clear();
  ...
  public boolean onOptionsItemSelected(final MenuItem item) {
    ...
    if (itemId == R.id.menu_history_send) {
        final CharSequence history = historyManager.buildHistory();
        final Uri historyFile = HistoryManager.saveHistory(history.toString());
        if (historyFile == null) {
          ...
          final String subject = getResources().getString(R.string.history_email_title);
        ...
        builder.setPositiveButton(R.string.button_ok, new DialogInterface.OnClickListener() {
          @Override
          public void onClick(final DialogInterface dialog, final int i2) {
